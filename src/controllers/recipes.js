...
exports.getRecipeByIngredients = async (req, res) => {
  ...
  const apiUrl = `https://api.spoonacular.com/recipes/complexSearch?includeIngredients=${ingredients}&diet=${diet}&intolerances=${intolerances}&addRecipeNutrition=true&number=1&apiKey=${API_KEY3}&number=2`;
